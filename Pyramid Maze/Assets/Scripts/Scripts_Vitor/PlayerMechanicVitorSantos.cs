...
public class PlayerMechanicVitorSantos : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        isMoving = false;
        if (collision.gameObject.name == "Edges" || collision.gameObject.name == "Walls" || collision.gameObject.name == "planta_mario(4)") {
            playerMoviment = Vector3.zero;
            isMoving = false;
